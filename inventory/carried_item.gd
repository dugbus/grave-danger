...
## Treasure score awarded when one copy is deposited; zero marks a utility item.
@export_range(0, 9999, 1) var treasure_value := 0
...
## Sound played by the world pickup when this item first lands on level geometry.
