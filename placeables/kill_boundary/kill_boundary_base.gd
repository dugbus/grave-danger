...
const FLAME_SHADER := preload("res://placeables/kill_boundary/effects/kill_boundary_flame_effect.gdshader")
const GHOST_SHADER := preload("res://placeables/kill_boundary/effects/kill_boundary_ghost_effect.gdshader")
