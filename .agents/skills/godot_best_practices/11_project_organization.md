...
Because of this, assets are now transparently imported from within the project folder. See Import process for more details on how importing works in Godot.
