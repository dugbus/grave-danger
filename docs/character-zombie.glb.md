...
| --- | ---              | ---              | ---                        | ---                     | ---                | ---               | ---                    |
| 0   | character-zombie | character-zombie | -0.40568, 0.02203, -0.1625 | 0.40568, 0.84717, 0.183 | 3,234              | 1,992             | 1,992                  |
...
| --- | ---       | ---       | ---            | ---          | ---      | ---     | ---                                                   | ---       | ---      |
| 0   | leg-left  | TRIANGLES | 1              | 110          | 218      | u8      | NORMAL:f32, POSITION:f32, TANGENT:f32, TEXCOORD_0:f32 | 1         | 10.79 KB |
| 1   | leg-right | TRIANGLES | 1              | 110          | 218      | u8      | NORMAL:f32, POSITION:f32, TANGENT:f32, TEXCOORD_0:f32 | 1         | 10.79 KB |
| 2   | torso     | TRIANGLES | 1              | 138          | 232      | u8      | NORMAL:f32, POSITION:f32, TANGENT:f32, TEXCOORD_0:f32 | 1         | 11.55 KB |
| 3   | arm-left  | TRIANGLES | 1              | 136          | 256      | u16     | NORMAL:f32, POSITION:f32, TANGENT:f32, TEXCOORD_0:f32 | 1         | 13.1 KB  |
| 4   | arm-right | TRIANGLES | 1              | 136          | 256      | u16     | NORMAL:f32, POSITION:f32, TANGENT:f32, TEXCOORD_0:f32 | 1         | 13.1 KB  |
| 5   | head      | TRIANGLES | 1              | 448          | 812      | u16     | NORMAL:f32, POSITION:f32, TANGENT:f32, TEXCOORD_0:f32 | 1         | 41.66 KB |
