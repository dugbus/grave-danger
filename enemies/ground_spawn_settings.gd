...
## Shared tuning for placing ground enemies on nearby level geometry.

## Maximum distance above an enemy spawn checked for a nearby walkable floor.
@export var below_floor_search_distance := 0.35
## Maximum distance below an airborne enemy spawn checked for a walkable floor.
@export var above_floor_search_distance := 8.0
